...
$(function () {
    ...
    $('.search-l').click(function () {
        $('.userManage .tab-nav li').each(function () {
            var thisClass = $(this).attr('class');
            if(thisClass!=null) {
                var hasCur = $(this).attr('class').indexOf('cur');
                if (hasCur > -1) {
                    var num = $(this).index();
                    if (num == 0) {
                        initTable1();
...
function initTable1() {
    ...
    var url =api+'getServiceDetail?searchInfo='+encodeURI(searchInfo)+'&searchType='+type+'&type=1';
    $('#table1').empty();
...
function initTable2(keyNum) {
    ...
    var url =api+'getServiceDetail?searchInfo='+encodeURI(searchInfo)+'&searchType='+type+'&type=2&num='+encodeURI(num);
    $('#table2').empty();
    $.getJSON(url,function (data) {
        dataTemp=data;
        data = data.datas==null?'':data.datas;
...
function initTable3(keyNum) {
    ...
    var url =api+'getServiceDetail?searchInfo='+encodeURI(searchInfo)+'&searchType='+type+'&type=3&num='+encodeURI(num);
    $('#table3').empty();
    $.getJSON(url,function (data) {
        dataTemp=data;
        data = data.datas==null?'':data.datas;
